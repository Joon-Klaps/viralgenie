...
workflow  {
    ...
    ch_contigs_depths= ch_contigs.join(METABAT2_JGISUMMARIZEBAMCONTIGDEPTHS.out.depths)

    METABAT2_METABAT2 ( ch_contigs, METABAT2_JGISUMMARIZEBAMCONTIGDEPTHS.out.depths )
    ...
    contig_depth    = METABAT2_JGISUMMARIZEBAMCONTIGDEPTHS.out.depths   // channel: [ val(meta), [ txt.gz ] ]
